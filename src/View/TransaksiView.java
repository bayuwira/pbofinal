...
public class TransaksiView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "pilih tipe transaksi", "Deposit", "Kredit" }));

        jTextField2.setForeground(new java.awt.Color(0, 144, 158));
        jTextField2.setEnabled(false);

        jTextField3.setForeground(new java.awt.Color(0, 144, 158));

        jTextField4.setForeground(new java.awt.Color(0, 144, 158));
