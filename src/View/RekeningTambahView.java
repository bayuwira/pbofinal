 ...
 * @author bayuw
 */
public class RekeningTambahView extends javax.swing.JFrame {

    /**
     * Creates new form Rekening
     */
    public RekeningTambahView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("- PEMBUKAAN REKENING BARU -");
        ...
        jLabel2.setText("Jenis Rekening  : ");
        ...
        jComboBox1.setForeground(new java.awt.Color(0, 144, 158));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "pilih id nasabah", "ID-001" }));

        jComboBox2.setForeground(new java.awt.Color(0, 144, 158));
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "pilih jenis rekening", "Biasa", "Bisnis" }));

        jTextField1.setForeground(new java.awt.Color(0, 144, 158));

        jTextField2.setForeground(new java.awt.Color(0, 144, 158));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RekeningTambahView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RekeningTambahView().setVisible(true);
            }
        });
    }
