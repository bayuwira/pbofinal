 ...
 * @author bayuw
 */
public class NasabahTambahView extends javax.swing.JFrame {

    /**
     * Creates new form TellerTambahView
     */
    public NasabahTambahView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NasabahTambahView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NasabahTambahView().setVisible(true);
            }
        });
    }
